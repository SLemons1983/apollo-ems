...
const styles: Record<string, string> = { DRAFT: 'bg-amber-100 text-amber-800', SUBMITTED: 'bg-blue-100 text-blue-800', COMPLETED: 'bg-emerald-100 text-emerald-800', REJECTED: 'bg-red-100 text-red-800' };
...
export default async function MyReportsPage() {
  ...
  return <main className="min-h-screen bg-gradient-to-br from-[#071632] via-[#0b3f78] to-[#0795e6] px-4 py-8 text-slate-900 sm:px-6"><div className="mx-auto max-w-5xl">
    <header className="rounded-3xl bg-white p-6 shadow-2xl sm:p-8"><a href="/epcr-dashboard" className="font-black text-blue-700">&larr; ePCR Dashboard</a><h1 className="mt-4 text-3xl font-black text-slate-950">My Reports</h1><p className="mt-2 text-slate-600">Continue drafts and track submitted reports and reviewer feedback.</p></header>
